                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: AppColor.Neutral20),
                                  ),
                                  child: Padding(
                                    padding: const EdgeInsets.all(5.0),
                                    child: Image.asset(
                                      'assets/pr/untitled portrait.png',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          Column(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(50),
                                  border: Border.all(color: AppColor.Neutral20),
                                ),
                                child: Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: Image.asset(
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: Image.asset(
                                    'assets/pr/untitled portrait-4.png',
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: Image.asset(
                                    'assets/portfolioimage/portfolio/following/프로필5.png',
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                  ...
                                  color: Colors.black),
                              child: Image.asset(
                                'assets/portfolioimage/shortpack/10.gif',
                                fit: BoxFit.fill,
                                width: 143,
                                height: 254,
                              ),
